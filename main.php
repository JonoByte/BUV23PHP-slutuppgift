            ...
            <div class="background-image">
                ...
                <div class="container">
                    <div class="row justify-content-end">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-6">
                            <div class="card mb-4">
                                <img class="card-img-top" src="img/kisspng-halo-4-halo-5-guardians-halo-the-master-chief-co-glowing-halo-5abe2f35099df7.4138996515224133650394.png" alt="Card image">
                                <div class="card-body">
                                    <h5 class="card-title">Game Title</h5>
                                    <p class="card-text">lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem lorem</p>
                                    <a href="#" class="btn btn-primary">test test</a>
